...
int main() {
  ...
  //
  {
    ...
    MyGraph<double> G;
    std::cout << "CONTEXT2 SHOULD NOT HAVE CREATED Tree for nullptr node"
              << std::endl;
    G.my_ctx().lock()->print();
    //
    G.print();
    ...
    std::cout << "make_node_owned 1.0" << std::endl;
    auto ptr1 = G.make_node_owned(1.0, G.entry);
    std::cout << "make_node_owned 2.0" << std::endl;
  ...
  // std::cout << "Next example requires merging trees... aborting (FOR NOW!)"
  // << std::endl; return 0;
  //
  {
    std::cout << " -------- THIS PART CREATES MULTIPLES TREES -------- "
              << std::endl;
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    G.print();
    // make cycle
    std::cout << "WILL MAKE CYCLE" << std::endl;
